...
fprintf('Running run_teammate_reduced_6par_identification.m\n');
...
fprintf('Estimated physical parameters: p_alpha, p_g1, p_g2, p_b1, p_b2, p_u.\n');
fprintf('No p_0 torque offset is included.\n');
...
%% ================================================================
% Create six-parameter teammate grey-box model
% ================================================================

modelFile = 'teammate_reduced_6par_model_fixed';
...
model0 = configureTeammate6ParModel(model0);
...
%% ================================================================
% Step 1: estimate six parameters and training initial velocities
% ================================================================
...
fprintf('\n============================================================\n');
fprintf('STEP 1: Estimate teammate six-parameter model and training ICs\n');
fprintf('============================================================\n');

modelParam = nlgreyest(zTrain, model0, optParam);
modelParam.Name = 'Teammate reduced six-parameter relative-coordinate model';
...
plotFitComparison(zTrain, zVal, yHatTrain, yHatVal, tTrain, tVal, fitTrain, fitVal, ...
    'Teammate reduced six-parameter model');

%% ================================================================
% Save result
% ================================================================

teammateReduced6.modelParam = modelParam;
teammateReduced6.modelTrainIC = modelTrainIC;
teammateReduced6.modelValIC = modelValIC;
teammateReduced6.fitTrain = fitTrain;
teammateReduced6.fitVal = fitVal;
teammateReduced6.settings.dataFile = dataFile;
teammateReduced6.settings.datasetName = datasetName;
teammateReduced6.settings.known_l1 = known_l1;
teammateReduced6.settings.known_g = known_g;
teammateReduced6.settings.theta1Offset = theta1Offset;
teammateReduced6.settings.theta2Offset = theta2Offset;
teammateReduced6.settings.fixInitialPositions = fixInitialPositions;
teammateReduced6.settings.velocityLimit = velocityLimit;
teammateReduced6.settings.outputWeight = outputWeight;

save('teammate_reduced_6par_result.mat', 'teammateReduced6');
fprintf('\nSaved result to teammate_reduced_6par_result.mat\n');
...
function model = configureTeammate6ParModel(model)
names = {'p_alpha', 'p_g1', 'p_g2', 'p_b1', 'p_b2', 'p_u'};
units = {'-', '1/s^2', '1/s^2', '1/s', '1/s', 'torque/input/beta'};
mins  = [0.001, 0, 0, 0, 0, 0];
maxs  = [300.0, 800, 800, 6000, 50, 20000];
for k = 1:numel(names)
...
modelIC.Name = sprintf('%s IC-only teammate reduced six-parameter model', label);
