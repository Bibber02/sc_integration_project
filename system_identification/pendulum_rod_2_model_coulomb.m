function [dx, y] = pendulum_rod_2_model_coulomb( ...
    t, x, u, p_b2, p_g2, p_Fc2, eps_v, varargin)
%PENDULUM_ROD_2_MODEL_COULOMB
% Nonlinear passive-link model for idnlgrey.
%
% Model:
%
%   theta_ddot =
%       -p_b2*theta_dot
%       -p_Fc2*tanh(theta_dot/eps_v)
%       -p_g2*sin(theta)
%
% States:
%   x(1) = theta      [rad]
...
%   p_Fc2  = smooth Coulomb friction strength  [rad/s^2]
...
coulomb_friction = p_Fc2 * tanh(theta_dot / eps_v);
