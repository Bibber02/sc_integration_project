...
doPlots = false;
x0 = [0; 0; 0; 0]; % x = [theta1; theta2; theta1_dot; theta2_dot]
Ts = 0.001;
...
kSigma  = 3;                               % uncertainty range = nominal +/- kSigma*sigma
...
%% Fixed smoothing / Stribeck constants
